...
public class ProjectRoleService
{
    ...
    /// </summary>
    public async Task<List<UserProjectAccessResult>> GetUserProjectAccessAsync(int userId)
    {
        ...
        var result = new List<UserProjectAccessResult>();
        foreach (var project in projects)
        {
            ...
            result.Add(new UserProjectAccessResult {
                Project = project,
...
/// </summary>
public class UserProjectAccessResult {
